...
#   - hexpm/elixir:1.19.5-erlang-28.5.0.1-debian-trixie-20260518-slim - for the release image
...
COPY --from=builder --chown=nobody:root /app/_build/${MIX_ENV}/rel/quick_average ./
